...
public class ShowRecordA extends javax.swing.JFrame {
  public ShowRecordA() {
    initComponents();
  }
  ...
  private java.util.List<String> confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {
    if (searchTextField.getText().equals((""))) {
      ...
      try {
        data = nurCtrl.getRecord(searchTextField.getText());
  ...
  public static void main(String args[]) {
    try {
      ...
      java.util.logging.Logger.getLogger(ShowRecordA.class.getName())
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new ShowRecordA().setVisible(true);
      }
    });
  }
  ...
  static java.util.List<String> data;
  private NurseController nurCtrl = new NurseController();
}
